...
function get_edit_del_id($id)
{
    ...
    $html = '
    <div class="btn-group">
        <a onclick="actEdit('.$id.')" data-toggle="tooltip" title="Edit" class="btn btn-icon-only  yellow"><i class="fa fa-pencil"></i> </a>
        <a style=" margin-left:5px; padding:3.5px;" onclick="actDelete('.$id.')" data-toggle="tooltip" title="Delete" class="btn btn-icon-only  red"><i class="fa fa-trash"></i> </a>
    </div>
    ';
