...
<body class="login" >
  ...
  <div class="logo">
    <!--<a>
      <img src="<?php echo base_url() . 'component/admin/assets/admin/layout2/img/syngenta-logo.png '?>" alt="" style="width:150px;height:50px;"/>
    </a>-->
  </div>
  <!-- END LOGO -->
  <!-- BEGIN LOGIN -->
  <div class="content">
    ...
    <form class="login-form" action="<?php echo base_url($this->cname).'/login'; ?>" method="post">
      <center><img src="<?php echo base_url() . 'component/template/assets/admin/layout2/img/logo-astro.png'?>" alt="" style="width:250px;height:200px;"/></center>
      <div class="alert alert-danger display-hide">
        ...
        <div class="form-group">
          ...
          <input  style="width:95%; padding: 5px; " class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="login-email"/>
        </div>
        <div class="form-group">
          <!--<label class="control-label visible-ie8 visible-ie9">Password</label>-->
          <input style="width:95%; padding: 5px; " class="form-control form-control-solid placeholder-no-fix " type="password" autocomplete="off" placeholder="Password" name="login-password"/>
        </div>
        <div class="form-actions">
          ...
          <div class="create-account" style="background:#003463;">
            <p>
              <a id="register-btn" class="uppercase">Menpro</a>
            </p>
          </div>
        </form>
        <!-- END LOGIN FORM -->
