              ...
              <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'admin/karyawan/simpan_ubah' ?>">
                <form action="#" id="form_sample_3" class="form-horizontal">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                  <label class="control-label col-md-3">Uname<span class="required">
                    * </span>
                  </label>
                  <div class="col-md-4">
                    <input type="text" name="uname" value="<?php echo $hasil_ambil_data->uname; ?>" data-required="1" class="form-control"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-3">Upass<span class="required">
                    * </span>
                  </label>
                  <div class="col-md-4">
                    <input type="text" name="upass" value="<?php echo paramDecrypt($hasil_ambil_data->upass); ?>" data-required="1" class="form-control"/>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                  <label class="control-label col-md-3">Tanggal Masuk<span class="required">
                      * </span>
                    </label>
                    <div class="col-md-4">
                      <input type="date" name="tanggal_masuk"  value="<?php echo $hasil_ambil_data->tanggal_masuk; ?>" data-required="1" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3">Tanggal Selesai Kontrak<span class="required">
                      * </span>
                    </label>
                    <div class="col-md-4">
                      <input type="date" name="tanggal_selesai_kontrak"  value="<?php echo $hasil_ambil_data->tanggal_selesai_kontrak; ?>" data-required="1" class="form-control"/>
                    </div>
                  </div>
                </div>
