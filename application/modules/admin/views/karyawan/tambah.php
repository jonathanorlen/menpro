        ...
        <div class="col-md-12">
          ...
          <div class="portlet box green">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-gift"></i>Input Karyawan
              </div>
              <div class="tools">
              ...
              <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'admin/karyawan/simpan_tambah' ?>">
                <form action="#" id="form_sample_3" class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="date" name="ttl" data-required="1" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" name="uname" data-required="1" class="form-control"/>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" name="upass" data-required="1" class="form-control"/>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="date" name="tanggal_masuk" data-required="1" class="form-control"/>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input type="date" name="tanggal_selesai_kontrak" data-required="1" class="form-control"/>
                  </div>
                </div>
