        ...
        <div class="col-md-12">
          ...
          <div class="portlet box green">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-gift"></i>Detail Karyawan
              </div>
              <div class="tools">
                ...
                <form action="#" id="form_sample_3" class="form-horizontal">
                  <div class="form-body">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label col-md-0" >
                        <?php echo $hasil_ambil_data->jekel;?>
                      </label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label col-md-0" >
                        <?php echo tanggalindo($hasil_ambil_data->ttl);?>
                      </label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label col-md-0" >
                        <?php echo $hasil_ambil_data->jabatan;?>
                      </label>
                    </div>
                    <div class="form-group">
                    ...
                    <label class="control-label col-md-3">Tanggal Masuk <span class="required">
                      ...
                      <label class="control-label col-md-0" >
                        <?php echo tanggalindo($hasil_ambil_data->tanggal_masuk);?>
                      </label>
                    </div>
                    <div class="form-group">
                      ...
                      <label class="control-label col-md-0" >
                        <?php echo tanggalindo($hasil_ambil_data->tanggal_selesai_kontrak);?>
                      </label>
                    </div>
