                    ...
                    <div class="theme-option">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                              ...
                              <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'admin/programer/simpan_tambah' ?>" enctype="multipart/form-data">
                                  <form action="#" id="form_sample_3" class="form-horizontal">
                                    <div class="form-body">
                                      <h3 class="form-section">Analisa.</h3>
                                      ...
                                      <div hidden  class="form-group">
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <select id="project" name="idproject" class="form-control" required>

                                            <?php
                                            $parameter = $_GET['id_t_produksi'];
                                            $this->db->group_by('nama_project');
                                            $get_project = $this->db->get_where('t_produksi',array ('id_project' => $parameter));
                                        ...
                                        <div class="box-footer clearfix" >
                                          <a class="btn btn-app blue" id="klikproject"> 
                                            submit
                                          </a>
                                        </div>
                                      </div>
                                      <div hidden class="form-group">
                                        <label class="control-label col-md-3">Modul<span class="required">
                                          * </span>
                                        </label>
                                        <div class="col-md-4">
                                          <select style="font-size: 1.5em;" name="idproduksi" class="form-control" >
                                            ...
                                            $parameter = $_GET['id_t_produksi'];
                                            $ambil_data = $this->db->query("SELECT * FROM t_produksi where id_project like '%$parameter%' ");
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input required="" type="file" name="prog" value="" /><br>
                      ...
                      <script type="text/javascript">
                        ...
                        $(function () {
                          ...
                          $("#klikproject").click(function()

                            {var parameter = $('#project').val();

                            $.ajax( {  
                              type :"post",  
                              url : "<?php echo base_url() . 'admin/programer/modul' ?>",  
                              cache :false,  
