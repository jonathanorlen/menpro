     ...
     <!--    <h3 class="page-title">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li>
            <a href="">Input Kategori Project</a>
          </li>
        </ul>
      </div>
      <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box green">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-gift"></i>Input Kategori Project
              </div>
              <div class="tools">
            ...
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'admin/kategori_project/simpan_tambah' ?>">
                <form action="#" id="form_sample_3" class="form-horizontal">
                  <div class="form-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="kategori" data-required="1" class="form-control"/>
                      </div>
                      </div>
                      <div class="form-group">
